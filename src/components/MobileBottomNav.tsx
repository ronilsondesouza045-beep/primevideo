...
import { Home, Grid, Sparkles, ShieldCheck, User as UserIcon, Award, Layers } from 'lucide-react';
...
export const MobileBottomNav: React.FC<MobileBottomNavProps> = ({
  ...
  return (
    <nav className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-slate-950/95 backdrop-blur-lg border-t border-slate-800/80 px-1.5 py-1.5 shadow-2xl">
